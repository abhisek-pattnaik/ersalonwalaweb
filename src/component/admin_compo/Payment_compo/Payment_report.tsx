...
export default function Payment_report() {
  ...
  return (
    <div className="mt-6 text-gray-200  font-sans">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-8 bg-[#0d111d] p-4 rounded-xl border border-[#1f293d] flex-wrap">
        <div className="flex flex-wrap gap-4 w-full md:w-auto" id="payemnt-fillter">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-[#0d111d] p-6 rounded-2xl border border-[#1f293d]">
          ...
          {/* Bar Chart Grid */}
          <div className="flex items-end justify-between h-64 px-2 pt-8 border-t border-[#1a202c] overflow-auto">
            {weeklyData.map((d, i) => (
              <div key={i} className="flex flex-col items-center flex-1 mx-4 relative group">
