   ...
   <div className=" w-full font-sans">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2">
        {stats.map((stat) => (
          <div
            key={stat.id}
            className="bg-[#101726] border border-slate-800/80 p-3 rounded-2xl shadow-xl flex flex-col justify-between h-44 transition-all duration-200 hover:border-slate-700/60"
          >
