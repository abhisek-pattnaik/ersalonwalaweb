...
export default function Fillter_and_addfraches() {
 ...
 const [isOpen, setIsOpen] = useState(false);
  ...
  <div className="flex flex-col md:flex-row justify-between items-center w-full  mx-auto gap-10" >
    
    <div className="flex bg-[#111827] p-1.5 rounded-xl border border-gray-800" id="filter-section">
    ...
    <button className="flex items-center gap-2 px-20 py-3 bg-gradient-to-r from-cyan-400 to-blue-500 text-white text-sm font-semibold rounded-2xl shadow-lg hover:opacity-90 transition duration-200"
  ...
  <div className="w-full  mx-auto bg-[#111827] border border-gray-800 rounded-2xl p-6 flex flex-col md:flex-row justify-between items-center gap-6" id="filter-section">
