...
const [selectedCustomer, setSelectedCustomer] = useState(customersData[0]);
  ...
  return (
    <div className="min-h-screen  text-gray-200 font-sans p-1" >
      {/* Top Accent Line */}
      ...
      <div className="max-w-9xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            <div key={index} className="bg-[#131A29] p-6 rounded-xl border border-[#1F293D] flex flex-col justify-between  h-36">
        ...
        {/* Filter Bar */}
        <div className="bg-[#131A29] p-4 rounded-xl border border-[#1F293D] flex flex-wrap items-center justify-between gap-4" id="costomer-fillter">
